...
@Component({
  ...
  template: `
    <div class="page-header">
      ...
      <div class="page-subtitle">Intended users: Teacher / Admin (static user mode)</div>
    </div>
...
export class CertificatesPage {
  ...
  readonly displayedColumns = ['id', 'studentId', 'issuedAt', 'skillLevel', 'valid', 'actions'];
  ...
  downloadUrl(id: UUID): string {
    return this.api.getCertificateDownloadUrl(id);
  }
}
